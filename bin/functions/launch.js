...
module.exports = {
    'launch': (fs, Authenticator, OSname, electron, mclc, args, request, host, importSettings, importPacks, consoleW, mainWindow) => {
        let launchable = true;
        if(launchable){
        //console.log(args);
        ...
        if(packName == "vanilla"){
            ...
            opts = {
                ...
                root: "C:/Users/"+OSname+"/Documents/.slpmods/modpacks/"+packName,
                os: "windows",
                version: {
                  number: args[1],
                  type: "release"
